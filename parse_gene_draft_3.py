"""
gRNA Design Project Draft 3

    This script scans the selected record from the TP53 FASTA file, and 
    identifies candidate guide RNA's for the CRIPSR SpCas9 complex.
    ...
    Additions in Draft 3: 
        - Addition of GC content filter
        - Script prints gRNA's only with GC content between 40%-60%
            
    Current Limitations/Future Additions
    - Results are printed to stdout and not to a file. 
