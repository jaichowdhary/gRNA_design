...
gRNA Design Project Draft 5
    ...
    Additions in Draft 5: 
        - Post filtering, the guides are written to and stored in memory 
        in a list
        - The list is used to write to the tab-separated file
        -Output is in a cleaner .tsv format
...
with open("gRNA_doc.tsv","w") as file_name:
    file_name.write("PAM Position\tGuide Sequence\tGC Percentage\n")
